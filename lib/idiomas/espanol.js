...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE NEKOTINA 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR NEKOTINA 🐈`}
...
const smsCodigoQR = () => { return `\n✅HOLA SOY MONOVAN TE PIDO QUE ESCANEES EL CÓDIGO QR PORQUE SOLO DURA 45 SEGUNDOS ✅`}
...
//_allantilink.js
const smsTextoYT = () => { return '𝗖𝗿𝗲𝗮𝗱𝗼 𝗽𝗼𝗿 𝘼𝙉𝙏𝙃𝙊𝙉𝙔 𝙑𝙀𝙉𝙏𝘼𝙎'} 
...
//_antiviewonce.js
const smsAntiView = () => { return `*𝙈𝘼𝙎𝙏𝙀𝙍 𝙔𝙊 𝙇𝙊 𝙑𝙀𝙊 𝙏𝙊𝘿𝙊 𝘼𝙌𝙐𝙄* 😎`} 
...
//propietario(a).js
const smsJoin = (user) => { return `${packname}\n𝙀𝙎 𝙐𝙉 𝘽𝙊𝙏 𝘿𝙀 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝙌𝙐𝙀 𝙏𝙀 𝘼𝙔𝙐𝘿𝘼𝙍𝘼 𝙍𝙀𝘼𝙇𝙄𝙕𝘼𝙍 𝘿𝙄𝙁𝙀𝙍𝙀𝙉𝙏𝙀𝙎 𝘼𝘾𝙏𝙄𝙑𝙄𝘿𝘼𝘿𝙀𝙎 🪄 𝘼𝙇 𝙋𝙍𝙄𝙑𝘼𝘿𝙊 𝙊 𝙂𝙍𝙐𝙋𝙊 𝙔 𝙏𝘼𝙈𝘽𝙄𝙀𝙉 𝙏𝙀 𝙑𝘼𝙎 𝘼 𝘿𝙄𝙑𝙀𝙍𝙏𝙄𝙍 🎈 𝘾𝙊𝙉 𝙎𝙐𝙎 𝙈𝙐𝙇𝙏𝙄𝙋𝙇𝙀𝙎 𝙁𝙐𝙉𝘾𝙄𝙊𝙉𝙀𝙎, 𝘿𝙄𝙎𝙁𝙍𝙐𝙏𝘼 𝘿𝙀 𝙉𝙀𝙆𝙊𝙏𝙄𝙉𝘼!!! 😸\n\n💖 𝙉𝙀𝙆𝙊𝙏𝙄𝙉𝘼 𝙁𝙐𝙀 𝙄𝙉𝙑𝙄𝙏𝘼𝘿𝘼 𝙋𝙊𝙍:\n@${user}`}
...
//info-contacto.js
const smsContacto1 = () => { return ' Soy Nekotina un Bot de WhatsApp dedicado en ayudar con lo que me pidas 😎'}
const smsContacto2 = () => { return 'Soy Owner de Nekotina sí tienes alguna duda me la puedes decir ✌️'}
const smsContacto3 = () => { return '👑 Owner'}
const smsContacto4 = () => { return 'Contacto Oficial de Nekotina 🐈'}
